...
if __name__ == '__main__':
    ...
    upload_rows = read_upload(os.path.join(DATA, '上传数据_增强版_0814.csv'))
    hist_rows   = read_delivery(os.path.join(DATA, '投后数据-编导-历史.csv'), week_only=False)
    week_rows   = read_delivery(os.path.join(DATA, '【周报】投后素材看板数据-编导-0814.csv'), week_only=False)
